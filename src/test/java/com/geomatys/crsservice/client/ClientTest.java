...
public class ClientTest extends AbstractIntegrationTest {
    ...
    public void operationTest() throws Exception {
        ...
        CRSServiceCoordinateOperationFactory factory = new CRSServiceCoordinateOperationFactory(new URI(getServerUrl()+"/crs/operation"));
...
//        testTransform(factory, "EPSG:4326", "EPSG:4978", new double[]{48, 2}, true);
        ...
        //Linear transform test
//        testTransformPython(factory, "EPSG:4326", "CRS:84", new double[]{10, 20}, true);
        //Mercator
//        testTransformPython(factory, "EPSG:4326", "EPSG:3395", new double[]{10, 20}, true);
        //EquidistantCylindrical
//        testTransformPython(factory, "EPSG:4326", "EPSG:4087", new double[]{10, 20}, true);
        //PolarStereographic
//        testTransformPython(factory, "EPSG:4326", "EPSG:3031", new double[]{60, 20}, true);
        //TransverseMercator
//        testTransformPython(factory, "EPSG:4326", "EPSG:32231", new double[]{48, 2}, true);
        //Lambert Conic
//        testTransformPython(factory, "EPSG:4326", "EPSG:2154", new double[]{48, 2}, true);
        //Geocentric
//        testTransformPython(factory, "EPSG:4326", "EPSG:4978", new double[]{48, 2}, true);
...
//        testTransformPython(factory, crs2.toWKT(), crs1.toWKT(), new double[]{40,50,100}, false);
        testTransformPython(factory, crs2.toWKT(), crs3.toWKT(), new double[]{40,50,100}, true);
    }
    ...
    private void testTransformPython(CRSServiceCoordinateOperationFactory factory, String source, String target, double[] coords, boolean testInverse) throws FactoryException, TransformException {
        final CoordinateReferenceSystem crsSource = parseCRS(source, false);
        final CoordinateReferenceSystem crsTarget = parseCRS(target, false);
        final CoordinateOperation distop = factory.createOperation(crsSource, crsTarget, "text/x-python");
        final MathTransform distTrs = distop.getMathTransform();
        final double[] distRes = new double[distTrs.getTargetDimensions()];
        distTrs.transform(coords, 0, distRes, 0, 1);
